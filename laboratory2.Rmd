...
- _Clone the package repository and open a new RStudio window with the package project.  (You can use the terminal with "git clone" command, or the RStudio option within "New" option)._
